...
(doom! :input
       ...
       (corfu +orderless +icons +dabbrev) ; complete with capf, cape and a flying feather!
       ...
       (popup +defaults)              ; tame sudden yet inevitable temporary windowsc
       ...
       ;;(kotlin +tree-sitter)             ; a better, slicker JavaScript
