# Generated by Powerlevel10k configuration wizard on 2025-03-31 at 02:10 WIB.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31091.
# Wizard options: nerdfont-v3 + powerline, large icons, ascii, lean_8colors, 2 lines,
# solid, white-ornaments, sparse, concise, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  function prompt_my_gnome_term_title() {
